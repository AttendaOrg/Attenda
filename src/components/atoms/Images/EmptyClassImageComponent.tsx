...
const EmptyClassImageComponent: React.FC<IconsPops> = ({
  ...
  return (
    <Svg viewBox="0 0 500 500" height={height} width={width}>
      ...
      />
      <Path fill="#e0e0e0" d="M283.33 79.27h150.7v129.56h-150.7z" />
      <Path fill="#f0f0f0" d="M286.68 79.27h150.7v129.56h-150.7z" />
      <Path fill="#fafafa" d="M431.37 85.35v117.4H292.69V85.35z" />
      <Path
        fill="#e0e0e0"
        d="M387.05 85.35v117.4h-9.06V85.35zM339.39 85.35v117.4h-9.06V85.35z"
      />
      <Path
        fill="#f0f0f0"
        d="M390.24 80.82V206.6h-9.06V80.82zM342.57 80.83v125.78h-9.06V80.83z"
      />
      <Path
        fill="#e0e0e0"
        d="M431.37 85.34v117.4h-2.53V85.34zM177.34 181.59S159 150 184.45 124.81c0 0 6.64 4.33 6.54 10.15s-7.12 7.29-5.61 12.15 8.12 9.61 3.78 13.63.7 7.58.41 12.5-12.23 8.35-12.23 8.35z"
      />
      <Path
        d="M180.22 186.76s7.44-35.78-24.64-51.64c0 0-4.94 6.2-3 11.69s9.05 4.67 9.15 9.76-4.67 11.69.71 14.13 1.73 7.42 3.56 12 14.22 4.06 14.22 4.06z"
        fill="#e6e6e6"
      />
      <Path
        d="M163.89 177.67s.32 30.89 12.67 30.89 12.66-30.89 12.66-30.89z"
        fill="#f0f0f0"
      />
      <Path
        d="M89.69 196.94s.69 11.62 27.06 11.62 27.07-11.62 27.07-11.62z"
        fill="#e6e6e6"
      />
      <Rect
        x={350.64}
      ...
      />
      <Path
        d="M318.42 280s.5 16.3 19.59 16.3 19.6-16.3 19.6-16.3z"
        fill="#e6e6e6"
      />
      <Path fill="#e0e0e0" d="M299.83 258.47h-28.89v-5.7h28.89z" />
      <Path fill="#f0f0f0" d="M299.83 252.78h143.63v5.7H299.83z" />
      <Path fill="#e0e0e0" d="M299.83 302h-28.89v-5.7h28.89z" />
      <Path fill="#f0f0f0" d="M299.83 296.3h143.63v5.7H299.83z" />
      <Path fill="#e0e0e0" d="M276.02 258.47h5.33v123.92h-5.33z" />
      <Path fill="#f0f0f0" d="M299.83 258.47h5.33v123.92h-5.33z" />
      <Path fill="#e0e0e0" d="M419.65 258.47h5.33v123.92h-5.33z" />
      <Path fill="#f0f0f0" d="M438.13 258.47h5.33v123.92h-5.33z" />
      <Path fill="#e6e6e6" d="M62.37 215.81h27.32V374.9H62.37z" />
      <Path fill="#e6e6e6" d="M67.62 374.89h134.72v7.51H67.62z" />
      <Path fill="#f0f0f0" d="M207.58 374.89H89.69V215.8h117.89z" />
      <Path
        fill="#e6e6e6"
        d="M196.84 314.78h-96.41v-38.86h96.41zM196.84 360.72h-96.41v-38.86h96.41z"
      />
      <Path
        d="M159.46 280.18h-21.65a2.67 2.67 0 01-2.66-2.66 2.67 2.67 0 012.66-2.67h21.65a2.67 2.67 0 012.66 2.67 2.67 2.67 0 01-2.66 2.66z"
        fill="#f0f0f0"
      />
      <Path fill="#e6e6e6" d="M196.84 268.83h-96.41v-38.86h96.41z" />
      <Path
        d="M159.46 234.24h-21.65a2.67 2.67 0 01-2.66-2.67 2.67 2.67 0 012.66-2.66h21.65a2.67 2.67 0 012.66 2.66 2.67 2.67 0 01-2.66 2.67zM159.46 326.12h-21.65a2.67 2.67 0 01-2.66-2.66 2.67 2.67 0 012.66-2.67h21.65a2.67 2.67 0 012.66 2.67 2.67 2.67 0 01-2.66 2.66z"
        fill="#f0f0f0"
      />
      <Path fill="#e6e6e6" d="M89.69 208.56h121.53v7.25H89.69z" />
      <Path fill="#e0e0e0" d="M89.69 215.8H58.55v-7.25h31.14z" />
      <Path fill="#e6e6e6" d="M75.94 85.35h44.2v48.54h-44.2z" />
      <Path fill="#f0f0f0" d="M79.27 85.35h45.66v48.54H79.27z" />
      <Path fill="#fafafa" d="M121.1 89.17v40.89H83.09V89.17z" />
      <Path fill="#f0f0f0" d="M111.89 99.08v21.07H92.31V99.08z" />
      <Path fill="#e6e6e6" d="M133.22 71.02h33.52v36.01h-33.52z" />
      <Path fill="#f0f0f0" d="M136.43 71.02h33.87v36.01h-33.87z" />
      <Path fill="#fafafa" d="M167.46 73.86v30.33h-28.19V73.86z" />
      <Path fill="#f0f0f0" d="M153.36 81.35l-7.71 13.36h15.42l-7.71-13.36z" />
      <G>
      ...
      <G>
        ...
        />
        <Path
          d="M286.5 213.33h-74.39L245 239.5l50.43 19v-36.26a8.93 8.93 0 00-8.93-8.91z"
          fill="#407bff"
        />
        <Path
          d="M286.5 213.33h-74.39L245 239.5l50.43 19v-36.26a8.93 8.93 0 00-8.93-8.91z"
        ...
        <Rect
          ...
          height={105.37}
          rx={7.26}
          transform="rotate(90 362.46 258.01)"
          fill="#407bff"
        />
        <Rect
          x={345.63}
          ...
          height={105.37}
          rx={7.26}
          transform="rotate(90 379.045 241.425)"
          fill="#407bff"
        />
        <Rect
          x={345.63}
        ...
        <Rect
          ...
          height={36.15}
          rx={3.23}
          transform="rotate(90 404.44 233.56)"
          fill="#407bff"
        />
        <Rect
          x={385.1}
        ...
        <Rect
          ...
          height={27.71}
          rx={2.48}
          transform="rotate(90 366.855 252.895)"
          fill="#407bff"
        />
        <Rect
          x={352.04}
        ...
        <Rect
          ...
          height={258.89}
          rx={7.38}
          transform="rotate(90 237.41 102.1)"
          fill="#407bff"
        />
        <Rect
          x={223.36}
          ...
          opacity={0.5}
        />
        <Path fill="#407bff" d="M320.66 111.17v9.67h-70.25v-9.67z" />
        <Path fill="#fff" opacity={0.5} d="M320.66 111.17v9.67h-70.25v-9.67z" />
        <Rect
          x={248.54}
          y={-68.85}
          width={28.09}
          height={258.89}
          rx={7.38}
          transform="rotate(90 262.59 60.6)"
          fill="#407bff"
        />
      </G>
      <G>
        ...
        <Path
          fill="#e4897b"
          d="M158.09 410.99h7.35l.73-17.01h-7.35l-.73 17.01zM92.64 381.79l6.14 4.02 13.56-11.45-6.15-4.03-13.55 11.46z"
        />
        <Path
        ...
        />
        <Path
          d="M195.09 228.32l8.32-.21-4 8.66s-3.39.45-6.17-4.12l-2.93-3.5 3.37-.67a7.52 7.52 0 011.41-.16zM208.66 229.72l-4.76 7.18-4.49-.13 4-8.66 5.25 1.61z"
          fill="#e4897b"
        />
        <Path
          fill="#ce6f64"
          d="M166.17 393.98l-.38 8.77h-7.35l.38-8.77h7.35zM106.19 370.33l6.15 4.03-7 5.9-6.14-4.02 6.99-5.91z"
        />
        <Path
      ...
      <G>
        ...
        <Path
          fill="#e4897b"
          d="M333.49 410.84h-7.5l-.5-17.35h7.5l.5 17.35zM367.54 410.84h-7.5l-2.41-17.35h7.5l2.41 17.35z"
        />
        <Path
        ...
        <Path
          fill="#ce6f64"
          d="M325.49 393.49l.26 8.95h7.5l-.26-8.95h-7.5zM365.13 393.49h-7.5l1.25 8.95h7.49l-1.24-8.95z"
        />
        <Path
...
export default EmptyClassImageComponent;
