...
export const Default = (): JSX.Element => (
  <ClassSettings
    ...
    isCodeEnabled={boolean('isCodeEnanled', false)}
    isLinkEnabled={boolean('isLinkEnanled', false)}
    code={text('code', '')}
    link={text('link', '')}
    ...
    onCodeShare={(code: string) => action('onCodeShare')(code)}
    onLinkShare={(link: string) => action('onLinkShare')(link)}
  />
);
